...
class PFHCalPFHCalEvent(BaseEvent):
    ...
    def _load(self):
        ...
        self.embedding = input_event['PFcluster0Id'].values
        self.input_event = input_event

class PFHCalPFExperiment(BaseExperiment):
    ...
    def make_event(self, input_path, pred_path):
        return PFHCalPFHCalEvent(input_path=input_path, pred_path=pred_path, task='instance')
