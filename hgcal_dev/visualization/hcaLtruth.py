...
class HCalTruthEvent():
    ...
    def _load(self):
        ...
        input_event.rename(columns={'RHClusterMatch': 'labels_i', 'hit': 'labels_s'}, inplace=True) #need to change columns for hcal truth
    ...
    def top_n_clusters(self, n):
        ...
        out = HCalTruthEvent(self.input_path, self.pred_path, self.task)
