...
import pandas as pd
# %%
sem_wandb_version = '2synst79'
inst_wandb_version = '29qh8n8x'
...
plot_df = evt.input_event
plot_df['s_instance_label'] = plot_df[instance_label].astype(str)
px.scatter(plot_df, x='eta', y='phi', color=color, color_discrete_sequence=get_palette(plot_df[color]))
# %%
