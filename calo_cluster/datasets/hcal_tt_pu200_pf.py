...
@dataclass
class HCalTTPU200PFDataset(SparseDatasetMixin, CombineLabelsDatasetMixin, ScaledDatasetMixin, PandasDataset):
    pass


@dataclass
class HCalTTPU200PFOffsetDataset(SparseDatasetMixin, CombineLabelsDatasetMixin, OffsetDatasetMixin, ScaledDatasetMixin, PandasDataset):
    pass


@dataclass
class HCalTTPU200PFDataModule(SparseDataModuleMixin, CombineLabelsDataModuleMixin, ScaledDataModuleMixin, HCalTTPU200PFDataModuleMixin):
